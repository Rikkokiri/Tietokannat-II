 ...
 * Luokan ilmentymän avulla käsitellään tietokantaa
 */
public class Tietokantahaltija implements TietokantaRajapinta {
	...
	//------- Constructor -----------------------
	/**
	 * Tietokantahaltija-luokan ilmentymän konstructointi
	 */
	...
	/* PELAAJAN SUORITUKSET VÃ„YLÃ„LLÃ„
